...
"""
logo2 = """
\x1b[1;92m➣ NAME :           💗 RONJU ISLAM 💗
\x1b[1;91m➣ PGE NAME :  💣TERMUX TEACHER RONJU💣
...
def menu():
	os.system('clear')
	print logo
	print "\033[1;96m💖━━━━━━━━━💘💘💘(MAFIA-KILLER-RONJU)💘💘💘━━━━━━━━💖\n" 
...
def action():
	...
	if ahmad =='':
		...
		os.system('xdg-open https://youtube.com/c/RONJUTechnologychannel')
		login()
	elif ahmad =='0':
		exb()
	else:
		...
		try:
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q['error_msg']:
					print '\033[1;96m[RONJU-Checkpoint] ' + k + c + user + '  》  ' + pass1+'\n'
